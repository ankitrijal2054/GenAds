    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 flex flex-col items-center justify-center px-4 py-8 sm:py-12 lg:py-16">
      ...
      <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg overflow-y-auto max-h-[90vh]">
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-1 sm:mb-2">Get started</h2>
          <p className="text-xs sm:text-sm text-slate-400">Create an account to generate amazing ad videos</p>
        </div>
